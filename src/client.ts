...
export const postTweet = async () => {
    ...
    try {
        ...
        const imageContext = await Providers.gpt.binjie(`Generate a prompt for an image generation ai. The image should relate to the word: ${wotd.word}.\nThe word means: ${wotd.meaning}.\n\nUse the following tips while generating the description: 1. Describe the content of your image. 2. Describe the subject. 3. Add relevant details. 4. Describe the form and style. 5. Define the composition.. Don't use very difficult words in the description, keep it simple and easy to understand. Don't use overly complicated or uncommon words in the description. Use more adjectives in the description. Only respond with the description of the image, nothing else. The description should be less than 250 words.  The description should be less than 250 words. The image should be realistic and visually appealing to achieve high user engagement.`);
